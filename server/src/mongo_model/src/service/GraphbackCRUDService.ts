...
export interface GraphbackCRUDService<Type = any, GraphbackContext = any> {
     ...
     */
    create(name: string, data: NoteModel, options?: GraphbackRuntimeOptions, context?: GraphbackContext): Promise<Type>;
     ...
     * @param context context object passed from graphql or rest layer
     */
    findAll(name: any, options?: GraphbackRuntimeOptions, context?: GraphbackContext): Promise<Type[]>;
